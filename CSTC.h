...
class CSTC
{
    ...
    static struct itimerspec _itimer_plan, _itimer_redcount, _itimer_panelcount, _itimer_reportcount, _itimer_record_traffic, _itimer_plan_WDT, _itimer_plan_test;
